...
public class Lecture {
	/*
	 * 1. This method is named returnNotOne and it returns an int. Change it so
	 * that it returns something other than a 1.
	 */
	...
	/*
	 * 2. This method is named returnNotHalf and it returns a double. Change it
	 * so that it returns something other than a 0.5.
	 */
	...
	/*
	 * 5. This method should return the language that you're learning. Change it
...
/*		if(number == 3) {
	 ...
	 * equal to or greater than 18. Return "Adult" if it is or "Minor" if it's
	 * not.
	 */
	...
	/*
	 * 16. Return as above, but also return "Teen" if the number is between 13
	 * and 17 inclusive.
	 */
